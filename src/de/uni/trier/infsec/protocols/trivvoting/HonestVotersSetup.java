...
public class HonestVotersSetup {
        ...
        public static final HonestVotersSetup setup = new HonestVotersSetup();
	...
	private static boolean secret;  // SECRET INPUT
        private /*@ spec_public @*/ final byte[] voterChoices1;
		...
		// we check whether they yield the same results:
                ...
                // choose one of the possible ways the voters vote:
                voterChoices = new byte[Server.NumberOfVoters];
                chooseVoterChoices();
        }

        private void initVoterChoices() {
        ...
        private void computeCorrectResult() {
        ...
        private void chooseVoterChoices() {
                for (int i=0; i<Server.NumberOfVoters; ++i) {
        ...
        public byte getVoteForVoter(Voter v) {
                return voterChoices[v.ID];
        }
	...
	public static void main(String[] args) throws NetworkError {
		...
		// DETERMINE THE VOTERS' CHOICES AND THE CORRECT RESULT
                // HonestVotersSetup generated by line 19
            
                // abort, if the result is not the same in both cases
                if (!CorrectResult.exists) return;
	 ...
	 */
	static Result result(byte[] choices) {
	 ...
	 */
	static boolean sameResults(Result res1, Result res2 ) {
