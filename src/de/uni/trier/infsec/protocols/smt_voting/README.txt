How-To run the voting process:
 ...
 1. Run class de.uni.trier.infsec.functionalities.pki.real.PKIServer
    ...
    if you want to delete registered keys, you큞l have to delete this
    file.
 ...
 2. Run class de.uni.trier.infsec.protocols.smt_voting.ServerRegisterStandalone
    ...
    register it큦 keys at the PKI environment and store the serialized
...
6.2. For sending the vote to the server, the voter has to be
    ...
    it큦 content and the result to the bulletin board and terminates.
