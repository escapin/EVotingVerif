...
public class Params {
	...
	public static final int DEFAULT_LISTEN_PORT_SERVER_SMT = 4089; // Listen port for Voter requests

	public static final int DEFAULT_LISTEN_PORT_BBOARD_AMT = 4090; 		// Listen port for Server requests
	public static final int DEFAULT_LISTEN_PORT_BBOARD_SMT = 4091; 		// Listen port for Server requests
	public static final int DEFAULT_LISTEN_PORT_BBOARD_REQUEST = 4092; 	// Listen port for result requests
